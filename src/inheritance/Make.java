...
public abstract class Make extends Vehicle {
    ...
    Make(String brand, int year, String engineType) {
        super(year, engineType);    // "Bring in the previous attributes from parent class"
        this.brand = brand;
    }
    ...
    public String toString() {
        return "This vehicle is made by " + brand + " in " + year + " with a " + engineType + " engine";
